...
const DetailEnhancer = () => {
    ...
    const [enhanceFactor, setEnhanceFactor] = useState(3)
  ...
  return (
    <div className='uploader__section' style={{filter : isLoading ? "blur(8px)" : ""}}>
        <h2><span>Detail Enhancer </span> Tool</h2>
        ...
        <label className='range__value__label'>
          <input type="range" min="1" max="8" step="1" defaultValue="3" onChange={(e)=> setEnhanceFactor(e.target.value)}/><span>{enhanceFactor}</span>
        </label>
